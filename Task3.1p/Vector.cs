...
namespace Vector
{
        ...
        public void Sort<K>(K[] sequence, IComparer<K> comparer) where K : IComparable<K>
        {
            ...
            for (int i = 0; i < n - 1; i++)
            {
                for (int j = 0; j < n - i - 1; j++)
                {
                    ...
                    {
                        (sequence[j], sequence[j + 1]) = Swap(sequence[j], sequence[j + 1]);
                    }
                }
            }
        }
    ...
    {
        public InsertionSort(){} //default sorter
        public void Sort<K>(K[] sequence, IComparer<K> comparer) where K : IComparable<K>
        {
            int n = sequence.Length;
            for (int i = 1; i < n; i++)
    ...
    {
        public SelectionSort() {} //default Sorter
        ...
        public void Sort<K>(K[] sequence, IComparer<K> comparer) where K : IComparable<K>
        {
            ...
            for (int i = 0; i < n - 1; i++)
            {
                ...
                (sequence[i], sequence[min]) = Swap(sequence[i],sequence[min]);
            }
        }
    }
}